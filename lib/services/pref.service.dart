...
// Add a list of courses to PreferencesService class
  static List<String> get courses =>
      prefs!.getStringList('courses') ?? <String>[];

  static set courses(List<String> value) =>
      prefs!.setStringList('courses', value);
}
